...
}: {icon: React.ElementType;label: string;score: number;iconBg: string;}) =>
...
export const RecipeCardModal = ({
  ...
  const avgRating = (
  (recipe.ratings.taste + recipe.ratings.time + recipe.ratings.difficulty) /
  3).
  toFixed(1);
